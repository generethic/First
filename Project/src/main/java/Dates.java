...
public class Dates {
    ...
    public List<LocalDate> getTotalDates(String[] arrray) {
        totalDates = doWork(arrray);
        return totalDates;
    }

    protected SimpleDateFormat from = new SimpleDateFormat("yyyy-MM-dd");
    protected SimpleDateFormat to = new SimpleDateFormat("yyyy-M-d");
    ...
    private List<LocalDate> oneDate(String[] array) {
        List<LocalDate> list = new LinkedList<>();
